...
<head>
    <meta charset="UTF-8">
    <title>Vehicle Requisition Report</title>
...
<div class="page-wrapper">
    ...
    <div class="container">
        <div style="display: flex; align-items: center; margin-bottom: 20px;">
            ...
            <h1>Vehicle Requisition Report</h1>
        </div>
    ...
    <%
        try {
            ...
            String sql = "SELECT * FROM vehicle_entry_requests ORDER BY id DESC";
    ...
    %>
            <tr>
                ...
                <td><%= rs.getString("rejection_reason") != null ? rs.getString("rejection_reason") : "-" %></td>
            </tr>
    <%
            }
        } catch (Exception e) {
